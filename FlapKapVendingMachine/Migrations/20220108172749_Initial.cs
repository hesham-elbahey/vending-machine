...
namespace FlapKapVendingMachine.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stocks_VendingMachines_VendingMachineId",
                        column: x => x.VendingMachineId,
                        principalTable: "VendingMachines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Coins",
                columns: new[] { "Id", "Quantity", "Value", "VendingMachineId" },
                values: new object[,]
                {
                    { 1, 100, 5, 1 },
                    { 2, 100, 10, 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_ProductId_VendingMachineId",
                table: "Stocks",
                columns: new[] { "ProductId", "VendingMachineId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Stocks_VendingMachineId",
                table: "Stocks",
                column: "VendingMachineId");
        }
